...
_LOG_DIRECTORY_PATH_ENVIRONMENT_VARIABLE_KEY: Final = "GRAFT_LOG_DIRECTORY_PATH"

_LOGGING_LEVEL_ENVIRONMENT_VARIABLE_KEY: Final = "GRAFT_LOGGING_LEVEL"
...
_DEFAULT_APP_DIRECTORY_NAME: Final = "graft"
...
_DEVELOPER_LOG_FILE_LOG_FORMAT: Final = "%(asctime)s %(levelname)s:%(filename)s %(message)s"
...
def _create_rotating_developer_log_files_handler() -> handlers.RotatingFileHandler:
    ...
    formatter = logging.Formatter(fmt=_DEVELOPER_LOG_FILE_LOG_FORMAT, datefmt=_DEVELOPER_LOG_FILE_LOG_DATE_FORMAT)
