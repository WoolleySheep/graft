...
from graft.domain.task.dependency_graph import DependencyGraph, DependencyGraphView
from graft.domain.task.hierarchy_graph import HierarchyGraph, HierarchyGraphView
...
class System:
    ...
    def add_task(self, /, uid: UID) -> None:
        """Add a task."""
        self._attributes_register.add(uid)
        self._hierarchy_graph.add_task(uid)
        self._dependency_graph.add_task(uid)
