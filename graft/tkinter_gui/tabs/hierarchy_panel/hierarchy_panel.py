...
from graft.tkinter_gui.tabs.hierarchy_panel.creation_deletion_panel import (
    CreationDeletionPanel,
)
from graft.tkinter_gui.tabs.hierarchy_panel.hierarchy_graph import HierarchyGraph
...
class HierarchyPanel(ttk.Frame):
    def __init__(self, master: tk.Misc, logic_layer: architecture.LogicLayer) -> None:
        ...
        self.hierarchy_graph.grid(row=1)
