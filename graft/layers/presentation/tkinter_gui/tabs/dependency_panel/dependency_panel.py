...
from graft.layers.presentation.tkinter_gui.tabs.dependency_panel.creation_deletion_panel import (
    CreationDeletionPanel,
)
from graft.layers.presentation.tkinter_gui.tabs.dependency_panel.dependency_graph import (
    DependencyGraph,
)
